          ...
          <div className="rounded-[calc(2.5rem-6px)] overflow-hidden bg-[#F8F9FA] shadow-sm border border-black/[0.04] p-8 sm:p-12 lg:p-16 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-simona-teal/10 border border-simona-teal/25 text-simona-teal text-xs font-bold mb-4">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
                  <button
                    ...
                    className="w-full sm:w-auto pl-7 pr-2 py-2 rounded-full bg-simona-teal hover:bg-simona-teal-hover text-white text-xs font-semibold uppercase tracking-wider transition-all shadow-lg shadow-simona-teal/20 flex items-center justify-between group active:scale-98"
                  >
                    <span className="mr-3">Рассчитать кухню с техникой</span>
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto pl-6 pr-4 py-2.5 rounded-full bg-white hover:bg-zinc-50 text-[#16181B] text-xs font-semibold tracking-wide transition border border-black/[0.08] shadow-sm flex items-center justify-center group active:scale-98"
                  >
